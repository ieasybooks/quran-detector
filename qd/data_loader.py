...
import codecs
from utils import normalize_text, remove_tashkeel, GLOBAL_DELIMITERS
from models import Verse, Term
...
def add_verse(verse_text: str, verse_info: Verse, current_node: dict, strict: bool, ambig_set: set,
              min_length: int, stops: set):
    """
    ...
    if (num_words - min_length) > 0:
        ...
        add_verse(verse_text[next_index:], verse_info, original_node, strict, ambig_set, min_length, stops)

def add_ayat(filename: str, suras: list, all_nodes: dict, q_orig: dict, q_norm: dict,
             ambig_set: set, min_length: int, stops: set):
    """
    ...
    with codecs.open(filename, "r", "utf-8") as f:
        ...
        for line in f:
            ...
            add_verse(verse_text, verse_obj, all_nodes, True, ambig_set, min_length, stops)
